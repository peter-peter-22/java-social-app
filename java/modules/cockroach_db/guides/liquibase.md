...
```docker run -it cockroachdb/cockroach:v25.3.2 start-single-node --insecure```

CLI (if it doesn't start automatically):
...
## Cockroach docs
- [foreign key](https://www.cockroachlabs.com/docs/stable/foreign-key)
- [primary key](https://www.cockroachlabs.com/docs/stable/primary-key.html)
